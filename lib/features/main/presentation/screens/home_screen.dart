...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    final double balance =
        BlocProvider.of<PaymentSourcesCubit>(context).getBalance();
                  ...
                  builder: (BuildContext context, setShowDialogState) {
                    return GestureDetector(
                      onTap: () {
                        dialogShow = true;
                        setShowDialogState(() {});
                        showActionsDialog(context, setShowDialogState);
                      },
                      child: Container(
                        height: 56.h,
          ...
          body: SingleChildScrollView(
            child: Column(
              children: [
                ...
                buildSpendFrequencyChartWithDurationControl(
                    transactions, staticNow),
                    ...
                    ? Column(
                        ...
                        children: [
                          ...
                          Text(
                            'No transactions yet',
                            style:
                                TextStyles.darkW500.copyWith(fontSize: 24.sp),
                          ),
                        ],
                      )
                    : ListView.builder(
  ...
  void showActionsDialog(BuildContext context, StateSetter setShowDialogState) {
    showDialog(
